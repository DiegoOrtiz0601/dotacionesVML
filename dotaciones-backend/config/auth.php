...
return [
    ...
    */
    ...
    | sources representing each model/table. These sources may then
    ...
    */
    ...
    'providers' => [
        'users' => [
            'driver' => 'eloquent',
            'model' => App\Models\TblUsuarioSistema::class,
        ],
    ...
    |
    | The expire time is the number of minutes that the reset token should be considered valid.
    | This security feature keeps tokens short-lived so they have less
