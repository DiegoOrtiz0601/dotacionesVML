...
class TblSolicitudController extends Controller
{
    ...
    public function solicitudesParaEntrega(Request $request)
    {
        try {
            ...
            Log::info('📦 Solicitudes encontradas', ['total' => $solicitudes->count()]);

            foreach ($solicitudes as $solicitud) {
                Log::info('🔍 Analizando solicitud', ['codigo' => $solicitud->codigoSolicitud]);
                ...
                Log::info('👤 Empleados encontrados', ['total' => $empleados->count()]);
